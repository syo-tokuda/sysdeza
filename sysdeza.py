...
salt_reset_botton = false											#追加！！塩分量リセットボタンの押下を判定．初期値は”偽”
...
def Arduino_receive():
    ...
    try:
        ...
        receive_data=number=bus.read_word_data(address, 0)
        moisture_data = receive_data & 0x007F
        if bin(receive_data >> 7) & 0x000E :
